...
Blockly.Msg.CONTROLS_FOREACH_TITLE = "pour chaque %1 dans la liste %2"; /*"pour chaque élément %1 dans la liste %2";*//*kar*/
...
Blockly.Msg.LISTS_GET_INDEX_FROM_END = "depuis la fin, l'élément n°";
Blockly.Msg.LISTS_GET_INDEX_FROM_START = "l'élément n°";  // untranslated
...
Blockly.Msg.LISTS_SET_INDEX_SET = "modifier";
...
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_LOWERCASE = "mettre en minuscules";
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_TITLECASE = "mettre en Majuscule Au Début De Chaque Mot";
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_UPPERCASE = "mettre en MAJUSCULES";
...
Blockly.Msg.TEXT_CHARAT_FROM_END = "depuis la fin, obtenir la lettre n°";
Blockly.Msg.TEXT_CHARAT_FROM_START = "obtenir la lettre n°";
...
Blockly.Msg.TEXT_GET_SUBSTRING_END_FROM_END = "jusqu’à depuis la fin, la lettre n°";
Blockly.Msg.TEXT_GET_SUBSTRING_END_FROM_START = "jusqu’à la lettre n°";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END = "obtenir la sous-chaîne depuis la fin, depuis la lettre n°";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START = "obtenir la sous-chaîne depuis la lettre n°";
...
Blockly.Msg.TEXT_PROMPT_TYPE_NUMBER = "demander un nombre avec le message";
Blockly.Msg.TEXT_PROMPT_TYPE_TEXT = "demander un texte avec le message";
